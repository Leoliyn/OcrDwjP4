...
<div class='resume'>
    ...
    <form action='indexadmin.php?action=addBook' method="post">
        ...
        <label> Sous-Titre</label><input type="texte" class="form-control" id="ouv_soustitre" name = "ouv-soustitre" value="">
        ...
        <label> Description</label><input style="width: 100%;" name="ouv_description" id="ouv_description" /><br />
         <label> Mots clés (séparés par une virgule)</label><input style="width: 100%;" name="art_keywords" id="art_keywords" value="blog,écrivain,"/><br />   
