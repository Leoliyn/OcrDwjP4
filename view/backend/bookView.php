...
?>
 ...
 ?>
    ...
    <?php
     $desactive=$data['OUV_ENABLE'];
     if(!$desactive){
        echo '<a href="indexadmin.php?action=enableBook&amp;id='.$data['OUV_ID'].'" title="Cliquez pour activer  l\'ouvrage"><i class="fa fa-eye-slash  fa-2x "></i></a>';
     } else {
     echo '<a href="indexadmin.php?action=disableBook&amp;id='.$data['OUV_ID'].'" title="Cliquez pour désactiver  l\'ouvrage"><i class="fa fa-eye  fa-2x "></i></a>';
     }
 ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4><span class="fa fa-trash"></span> <?= $data['OUV_ID'] ?> Etes-vous sur de vouloir supprimer l'ouvrage ?</h4>
        </div>
