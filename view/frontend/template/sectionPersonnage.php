...
<div id="band" class="resume  text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      <p class="text-center"><strong>Jo Cash</strong></p><br>
      <a href="#window1" data-toggle="collapse">
        <img src="public/images/personnage.jpg" class="img-circle person" alt="Jo Cash" width="255" height="255">
      </a>
      <div id="window1" class="collapse">
